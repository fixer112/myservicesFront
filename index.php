    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Add SMS Coin</a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                ...
                <li><a href="#"> <i class="icon-logout"></i>Verify Transaction</a></li>
