  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          <li class="active"> <a href="USER.php"> <i class="icon-settings"></i>create User</a></li>
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">User Creation</h2>
          </div>
        </div>
        <!-- Form Elements -->
        <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Enter User information to Create User</strong></div>
