        ...
        <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>SMS</a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    ...
                    <li class="active"><a href="SMSGROUP.php">Create SMS Group</a></li>
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Create Group</h2>
          </div>
        </div>
<!-- Form Elements -->
<div class="col-lg-12">
                <div class="block">
                  ...
                  <div class="block-body">
                    <form class="form-horizontal">
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Group Phone Number</label>
                        <div class="col-sm-9">
