    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
          ...
          <li class="active"> <a href="UPDATE.php"> <i class="icon-writing-whiteboard"></i>Update User Profile</a></li>
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">Update User</h2>
          </div>
        </div>
        <!-- Form Elements -->
        <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Update  User information</strong></div>
                  <div class="block-body">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Chose Username</label>
                        <div class="col-sm-9">
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">User Full Name</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"><small class="help-block-none">Enter your Name followed by your Surname</small>
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
                      ...
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Update/Change Password </label>
                        <div class="col-sm-9">
                          <input type="text" name="password"  class="form-control">
                        </div>
                      </div>
                      <div class="block">
                  <div class="title"><strong>Select User Role/Function</strong></div>
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Click to Enable SMS for User</label>
                        <div class="col-sm-9">
                          <div>
                            <input id="option" type="checkbox" value="">
                            <label for="option">Enable SMS Role/Function</label>
                          </div>
                            </div>
                            </div>
                         <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Click to Enable BVN for User</label>
                        <div class="col-sm-9">
                          <div>
                            <input id="option" type="checkbox" value="">
                            <label for="option">Enable BVN Verification Role/Function</label>
                          </div>
                            </div>
                            </div>
                            <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Click to Enable Event for User</label>
                        <div class="col-sm-9">
                          <div>
                            <input id="option" type="checkbox" value="">
                            <label for="option">Enable Event and Registration Role/Function</label>
                          </div>
                            </div>
                            </div>
                            <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Click to Enable Transaction for User</label>
                        <div class="col-sm-9">
                          <div>
                            <input id="option" type="checkbox" value="">
                            <label for="option">Enable Transaction Verification Role/Function</label>
                          </div>
                            </div>
                            </div>
                            </div>
