        ...
        <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>SMS</a>
                  <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    ...
                    <li class="active"><a href="SMSUPDATE.php">Update SMS Group</a></li>
                  </ul>
                </li>
...
<div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>Create SMS Group</strong></div>
                  <div class="block-body">
                    <form class="form-horizontal">
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">UpdateGroup Name</label>
                        <div class="col-sm-9">
                          <input type="text" placeholder="Group Name E.g my family,myfrinds,my class, my office," class="form-control">
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Update Group Phone Number</label>
                        <div class="col-sm-9">
