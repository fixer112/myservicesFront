    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li class="active"><a href="BVNVER.php"> <i class="icon-grid"></i>Bvn Verification </a></li>
      ...
      <div class="page-content">
        <div class="page-header">
          <div class="container-fluid">
            <h2 class="h5 no-margin-bottom">BVN VERIFICATION CENTER</h2>
          </div>
        </div>
        <!-- Inline Form-->
        <div class="col-lg-8">                           
                <div class="block">
                  <div class="title"><strong>Please Enter a Corret Bvn Number</strong></div>
                  <div class="block-body">
                    <form class="form-inline">
                      <div class="form-group">
                        <label for="inlineFormInput" class="sr-only">BVN NUMBER</label>
                        <input id="inlineFormInput" type="text" placeholder="BVN" class="mr-sm-3 form-control">
                      </div>
                       <div class="form-group">
              ...
              <div class="col-lg-12">
                <div class="block">
                  <div class="title"><strong>SEARCH/VERIFICATION </strong></div>
                  <div class="block-body">
                    <form class="form-horizontal">
                    <div class="line"></div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">BVN SEARCH RESULT</label>
                        <div class="col-sm-9">
                          <input type="text" disabled="" placeholder="BVN RESULT" class="form-control">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">First Name</label>
                        <div class="col-sm-9">
                          <input type="text" disabled="" placeholder="Customer Fist Name" class="form-control">
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" disabled="" placeholder="Customer Last Name" class="form-control"><small class="help-block-none"></small>
                        </div>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" disabled="" name="Phone" placeholder="Customer Phone Number" class="form-control">
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
